...
class MUWbiWeibo extends SMWResultPrinter {
	...
	/*public function getResult( SMWQueryResult $results, array $params, $outputmode ) {
        ...
        public function getIndexUI($results,$outputmode){
            ...
            <input type="image" class="wbbtn" name="Sina" src="'.$wgStylePath.'/ccwiki/images/btn_sinaweibo.png" onclick="postSinaWeibo()"/> <input type="image" class="wbbtn" name="Tecent" src="'.$wgStylePath.'/ccwiki/images/btn_qqweibo.png" onclick="postQQWeibo()"/>
            </div>';
