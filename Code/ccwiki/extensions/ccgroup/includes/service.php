...
function getrenrenFriends($arg) {
	...
	global $ccSite;
	global $ccWiki;
	 $response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenFriend.php?access_token=".$arg);
     return  $response;
}
function postrenrenMessage($arg) {
	...
	global $ccSite;
	global $ccWiki;
	 $response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenMessage.php?access_token=".$arg[0]."&to_ids=".$arg[1]."&notification=".$arg[2]);
	return  $response;
}
function getkaixinFriends($arg) {
	...
	global $ccSite;
	global $ccWiki;
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/kaixinFriend.php?access_token=".$arg);
     return  $response;
}
function postkaixinMessage($arg) {
	...
	global $ccSite;
	global $ccWiki;
	 $response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/kaixinMessage.php?access_token=".$arg[0]."&fuids=".$arg[1]."&content=".$arg[2]);
	return  $response;
}
function getqqweiboFriends($arg) {
	...
	global $ccSite;
	global $ccWiki;
	 $response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/qqweiboFriend.php?oauth_token=".$arg[0]."&oauth_token_secret=".$arg[1]);
     return  $response;
}
function postqqweiboMessage($arg) {
	...
	global $ccSite;
	global $ccWiki;
     $response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/qqweiboMessage.php?oauth_token=".$arg[0]."&oauth_token_secret=".$arg[1]."&id=".$arg[2]."&content=".$arg[3]);
     return  $response;
}
function snsSmw($arg) {
	global $ccHost;
	...
	global $ccSite;
	global $ccWiki;
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/snsSmw.php?source=".$arg[0]."&access_token=".$arg[1]."&access_token_secret=".$arg[2]);
}
/*
...
//  $response=get("http://".$ccHost.":".$ccPort."/".$ccSite."/extensions/ccgroup/includes/weiboMashup.php?data=".$url."&title=".$title);
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/weiboMashup.php?data=".$url."&title=".$title);
	return $response;
}
/*
...
function sinaUpdate($arg) {
	...
	global $ccSite;
	global $ccWiki;
	if(!isset($_SESSION['sina_access_token'])){
		return 0;
	}
	$access_token=$_SESSION['sina_access_token'];
	$arg=urlencode($arg);
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/sinaweiboUpdate.php?access_token=".$access_token."&status=".$arg);
	return $response;
}
function qqweiboUpdate($arg) {
	...
	global $ccSite;
	global $ccWiki;
	if(!isset($_SESSION['qqweibo_access_token'])){
		return 0;
	}
	$access_token=$_SESSION['qqweibo_access_token'];
	$access_token_secret=$_SESSION['qqweibo_access_token_secret'];
	$arg=urlencode($arg);
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/qqweiboUpdate.php?oauth_token=".$access_token."&oauth_token_secret=".$access_token_secret."&content=".$arg);
...
function getGroupBuy($arg) {
	...
	$response=get("http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/groupBuy.php?gb=".$gb."&language=".$city."&keyword=".$keyword."&endTime=".$time);
	return $response;
}
?>
