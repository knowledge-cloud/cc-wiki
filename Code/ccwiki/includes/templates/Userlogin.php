...
<div class="main">
<div class="loginbox">
<h5><div>登录</div></h5><div><?php $this->html('link') ?></div>
...
<form name="userlogin" method="post" action="<?php $this->text('action') ?>">
	<table width="542" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;">
		<tr>
			<th width="279" height="40" align="right" class="mw-label"><label for='wpName1'>用户名:</label></th>
			<td width="263" class="mw-input">
				<?php
		...
		<tr>
			 <th height="40" align="right" class="mw-label"><label for='wpPassword1'>密 码:</label></th>
			<td class="mw-input">
				<?php
			...
			<td>
                        ...
                        /*if ( $this->data['useemail'] && $this->data['canreset'] ) {
                            echo '&nbsp;';
                            echo Html::input( 'wpMailmypassword', '忘记密码?', 'submit', array(
                                'id' => 'wpMailmypassword',
                                'tabindex' => '6'
                            ) );
                        }*/ ?>
...
<?php } ?>
		<tr>
			...
			<td  class="mw-submit">
				<?php
		echo Html::input( 'wpLoginAttempt', '登录', 'submit', array(
			'id' => 'wpLoginAttempt',
			'tabindex' => '9'
		) );
/*		if ( $this->data['useemail'] && $this->data['canreset'] ) {
