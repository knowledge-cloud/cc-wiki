...
'remembermypassword'         => '在这个浏览器上记住我的账户 (最大天数 $1 {{PLURAL:$1|天|天}})',
'securelogin-stick-https'    => '登陆后保持连接到HTTPS',
'yourdomainname'             => '您的域名:',
'externaldberror'            => 'There was either an authentication database error or you are not allowed to update your external account.',
'login'                      => '登陆',
'nav-login-createaccount'    => '登陆 / ',
'loginprompt'                => '为了登陆到 {{SITENAME}},您必须允许使用COOKIES.',
'userlogin'                  => '登陆 / 创建账户',
'userloginnocreate'          => '登陆',
'logout'                     => '注销',
'userlogout'                 => '注销',
'notloggedin'                => '还没登陆',
'nologin'                    => "还没有账户? $1.",
...
'gotaccount'                 => '已经有账户? $1.',
'gotaccountlink'             => '登陆',
'createaccountmail'          => '通过邮箱',
'createaccountreason'        => '理由:',
'badretype'                  => '您两次输入的密码不一致.',
'userexists'                 => '用户名已存在.
Please choose a different name.',
'loginerror'                 => '错误',
'createaccounterror'         => '不能创建账户: $1',
'nocookiesnew'               => '账户名以创建，但是你还没登陆.
{{SITENAME}} 使用COOKIES登陆.
您已禁止COOKIES.
请开启COOKIES，然后使用新密码和用户名登陆.',
'nocookieslogin'             => '{{SITENAME}} 使用COOKIES登陆，您已禁止COOKIES，请开启.',
'noname'                     => '你还未填入有效的用户名.',
'loginsuccesstitle'          => '登陆成功',
'loginsuccess'               => "'''您已成功登陆到 {{SITENAME}} 以 \"\$1\".'''",
'nosuchuser'                 => '用户名不存在 "$1".
用户名大小写敏感.
请检查您的拼写, 或者 [[Special:UserLogin/signup|create a new account]].',
...
'prefs-help-email'              => '邮箱是可选的，但是密码重置和找回密码时需要提供邮箱。',
