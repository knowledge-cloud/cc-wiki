...
$deal=$_REQUEST['deal'];
$url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/getqqweiboUserRdf.php?access_token=".$access_token."&access_token_secret=".$access_token_secret;
$ch = curl_init($url);//打开
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
if(exist("Person_".$user['sns_id'])){
	$result=$result."[[Ontology 0/participated::Deal_".$deal."| ]]";
}
else{
$result=$askPerson;
