...
$url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenConfig.php?access_token=".$access_token."&mw=".$mw;
jump($url);
if($action=="create"){
	...
	$keyword=$_SESSION['keyword'];
        ...
        $url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenCreatePage.php?access_token=".$access_token."&userPage=".$userPage;
         $uid=jump($url);
...
elseif ($action=="invite"){
	//$url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/snsSmw.php?source=renren&access_token=".$access_token;
	header("Location:http://".$ccHost.":".$ccPort."/".$ccSite."/index.php/Special:Invite?type=renren&access_token=".$access_token);
	
}
elseif ($action=="participate"){
	$deal=$_SESSION['deal'];
	$deal=rawurlencode($deal);
        $url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenParticipate.php?access_token=".$access_token."&deal=".$deal;
	async($url);
...
elseif ($action=="interest"){
	$deal=$_SESSION['deal'];
        $deal=rawurlencode($deal);
	$url="http://".$ccHost.":".$ccPort."/".$ccWiki."/includes/renrenInterest.php?access_token=".$access_token."&deal=".$deal;
         async($url);
header("Location:http://".$ccHost.":".$ccPort."/".$ccSite."/extensions/mashupwiki/Interface/MashupPageInterface.php?a=purgePage");
